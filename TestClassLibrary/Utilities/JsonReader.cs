...
namespace PortalApplicationFramework.Utilities
{
    ...
    {
        public string extractData1LoginCredentials(String tokenName)
        {
            String myJsonString = File.ReadAllText(@"C:\selenium_automation_framework\selenium_automation_framework\TestClassLibrary\Utilities\TestDataFiles\1LoginCredentials-testData.json");
