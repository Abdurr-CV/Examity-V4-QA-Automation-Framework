...
{
    class RevenueReportPage : BasePage
    {
        private IWebDriver driver;
        public RevenueReportPage(IWebDriver driver)
        {
            this.driver = driver;
        ...
        [FindsBy(How = How.CssSelector, Using = "img[title='Revenue Report']")]
        private IWebElement iconRevenueReport;
        ...
        public void navigateToRevenueReportpage(string reportTab, string LoginpageUrl)
        {
            ...
            try
            {
                ClickElement(iconRevenueReport);
                ReportLog("Passed", "Clicked on Revenue reort icon");
            }
            catch (Exception ex)
            {
                ReportLog("Failed", "Didn't click on Revenue report icon");
                throw ex;
            }
            Sleep(5000);
        }
