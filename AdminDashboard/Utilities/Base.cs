...
namespace AdminDashboard.Utilities
{
    ...
    public class Base
    {
        ...
        public void SetUp()
        {
            ...
            var htmlReporter = new ExtentHtmlReporter(@"C:\selenium_automation_framework\selenium_automation_framework\AdminDashboard\Utilities\HTML Extension\index.html");
        ...
        public void WriteToFile()
        {
            ...
            builder.Attachments.Add(@"C:\selenium_automation_framework\selenium_automation_framework\AdminDashboard\Utilities\HTML Extension\index.html");
