...
{
    class ExamStatusCountPage : BasePage
    {
        private IWebDriver driver;
        public ExamStatusCountPage(IWebDriver driver)
        {
            this.driver = driver;
        ...
        [FindsBy(How = How.CssSelector, Using = "img[title='Exam status Count']")]
        ...
        public void navigateToExamStatusCount(string reportTab, string LoginpageUrl)
        {
            ...
            try
            {
                ...
                ReportLog("Passed", "Selected Exam-count icon");
            }
            catch (Exception)
            {
