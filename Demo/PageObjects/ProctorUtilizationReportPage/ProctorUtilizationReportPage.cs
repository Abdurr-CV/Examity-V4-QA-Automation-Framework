...
namespace Demo.PageObjects
{
    class ProctorUtilizationReportPage : BasePage
    {
        ...
        public void navigateToProctorUtilizationReportPage(string reportTab, string LoginpageUrl)
        {
            ...
            try
            {
                ...
                ReportLog("Passed", "Clicked on details viewing tab");
            }
            catch (Exception ex)
            {
                ReportLog("Failed", "Didn't click on details viewing tab");
                throw ex;
            }
        }
