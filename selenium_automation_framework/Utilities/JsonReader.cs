...
namespace PortalApplicationFramework.Utilities
{
    public class JsonReader
    {
        ...
        {
            String myJsonString = File.ReadAllText("C:/Users/AbdurRahman/Downloads/selenium_automation_framework/selenium_automation_framework/selenium_automation_framework/Utilities/TestDataFiles/AccountManagerReport-testData.json");
        ...
        {
            String myJsonString = File.ReadAllText(@"C:\selenium_automation_framework\selenium_automation_framework\selenium_automation_framework\Utilities\TestDataFiles\LoginCredentials-testData.json");
            var jsonObject = JToken.Parse(myJsonString);
            return jsonObject.SelectToken(tokenName).Value<string>();
        }
